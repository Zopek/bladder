...
train_path = '/DB/rhome/qyzheng/Desktop/qyzheng/source/renji_data/process/dwi_t2w_t2wfs/0_cv_train.csv'
val_path = '/DB/rhome/qyzheng/Desktop/qyzheng/source/renji_data/process/dwi_t2w_t2wfs/0_cv_val.csv'
train_set = []
test_set = []
train_size = 0
test_size = 0
...
with tf.Session() as sess:
    ...
    for epoch in range(total_epochs):
        ...
        for step in range(test_epoch):
            phase = 'test'
            test_images, test_labels = read_data.next_batch(test_set, batch_size, height, width, step, class_num, phase)
            test_feed_dict = {
                x: test_images,
                label: test_labels,
                learning_rate: epoch_learning_rate,
            ...
            if step == test_epoch - 1:
                print('Epoch:', '%04d' % (epoch + 1), '/ Test Accuracy =', accuracy_rates/test_epoch)
        ...
        if best_accuracy < accuracy_rates/test_epoch:
            best_accuracy = accuracy_rates/test_epoch

...
def test():
    ...
    to_tensor = ToTensor()
    dataset = BladderDwiDataset('/DB/rhome/qyzheng/Desktop/qyzheng/source/renji_data/process/dwi_t2w_t2wfs/all_sizes.csv', preprocessor,
    ...
    for i in range(1000):
        ...
        asample = dataset[i]
        if asample['label'] == 1 and asample['accession_number'] == 'D0564603':
            fig = plt.figure()
            ...
            plt.show()
            plt.savefig('/DB/rhome/qyzheng/Desktop/qyzheng/PROGRAM/bladder/show/sample_paper/D0564603_aug_images.png')

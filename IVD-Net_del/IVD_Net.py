...
class IVD_Net_asym(nn.Module):
    ...
    def __init__(self,input_nc, output_nc, ngf):
        ...
        self.down_2_0 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 5, self.out_dim * 2, act_fn)
        self.pool_2_0 = maxpool()
        self.down_3_0 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 15, self.out_dim * 4, act_fn)
        self.pool_3_0 = maxpool()
        self.down_4_0 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 35, self.out_dim * 8, act_fn)
        ...
        self.down_2_1 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 5, self.out_dim * 2, act_fn)
        self.pool_2_1 = maxpool()
        self.down_3_1 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 15, self.out_dim * 4, act_fn)
        self.pool_3_1 = maxpool()
        self.down_4_1 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 35, self.out_dim * 8, act_fn)
        ...
        self.down_2_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 5, self.out_dim * 2, act_fn)
        self.pool_2_2 = maxpool()
        self.down_3_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 15, self.out_dim * 4, act_fn)
        self.pool_3_2 = maxpool()
        self.down_4_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 35, self.out_dim * 8, act_fn)
        ...
        self.down_2_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 5, self.out_dim * 2, act_fn)
        self.pool_2_3 = maxpool()
        self.down_3_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 15, self.out_dim * 4, act_fn)
        self.pool_3_3 = maxpool()
        self.down_4_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 35, self.out_dim * 8, act_fn)
        self.pool_4_3 = maxpool()
        
        # Encoder (Modality 5)
        self.down_1_4 = Conv_residual_conv_Inception_Dilation_asymmetric(self.in_dim, self.out_dim, act_fn)
        self.pool_1_4 = maxpool()
        self.down_2_4 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 5, self.out_dim * 2, act_fn)
        self.pool_2_4 = maxpool()
        self.down_3_4 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 15, self.out_dim * 4, act_fn)
        self.pool_3_4 = maxpool()
        self.down_4_4 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 35, self.out_dim * 8, act_fn)
        self.pool_4_4 = maxpool()

        # Bridge between Encoder-Decoder
        self.bridge = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 75, self.out_dim * 16, act_fn)
    ...
    def forward(self,input):
        ...
        down_3_4m = self.pool_3_0(down_3_4)
        ...
        skip_1 = (deconv_1 + down_4_0 + down_4_1 + down_4_2 + down_4_3 + down_4_4)/6  # Residual connection
        up_1 = self.up_1(skip_1)
        deconv_2 = self.deconv_2(up_1)
        skip_2 = (deconv_2 + down_3_0 + down_3_1 + down_3_2 + down_3_3 + down_3_4)/6 # Residual connection
        up_2 = self.up_2(skip_2)
        deconv_3 = self.deconv_3(up_2)
        skip_3 = (deconv_3 + down_2_0 + down_2_1 + down_2_2 + down_2_3 + down_2_4)/6  # Residual connection
        up_3 = self.up_3(skip_3)
        deconv_4 = self.deconv_4(up_3)
        skip_4 = (deconv_4 + down_1_0 + down_1_1 + down_1_2 + down_1_3 + down_1_4)/6  # Residual connection

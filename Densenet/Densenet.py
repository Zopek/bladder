...
val_path = '/DB/rhome/qyzheng/Desktop/qyzheng/source/renji_data/process/period/0_period_val.csv'
...
with tf.Session() as sess:
    ...
    for epoch in range(total_epochs):
        ...
        if best_acc < accuracy_rates/test_epoch:
            best_acc = accuracy_rates/test_epoch
        print('best', best_acc)
        """

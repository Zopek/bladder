...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, output_logits=True):
        self.inplanes = 64
        ...
        if self._output_logits:
            ...
            self.num_out_channels = 512 * block.expansion
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        downsample = None
        if stride != 1 or self.inplanes != planes * block.expansion:  # stride!=1 or input_channels != output_channels
